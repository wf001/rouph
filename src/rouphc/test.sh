...
assert_input() {
    ...
    if [ "$actual" = "$expected" ]; then
        echo -e "\e[1;32mPASSED\e[0m : '$input' : '$1'"
    else
        echo -e "\e[1;31mFAILED\e[0m : '$input' : '$1'=> '$actual'"
        msg="NG"
        code=-1
    fi
}
...
# Assertion
#############
echo -e "\e[1;34m< put >\e[0m"
assert_input 'cat expected/imms' 'func main():int{put("abc");}'
assert_input 'echo 20000000' 'func main():int{let a:int=10000000; let b:int = 10000000;let c:int = a+b;put(c);}'
assert_input 'echo 65536' 'func main():int{let a:int=65535; let b:int = 1;let c:int = a+b;put(c);}'
assert_input 'echo 2147483648' 'func main():int{let a:int=2147483647; let b:int = 1;let c:int = a+b;put(c);}' # maximum uint value

assert_input 'echo 5' 'func main():int{let a:int=2; let b:int = 3;let c:int = a+b;put(c);}'
...
assert_input 'cat expected/imms-vs-vnum' 'func main():int{let a:char*="abc";put("hoge");put(a);let b:int=13;put(b);}'
assert_input 'cat expected/imms-vs-vnum' 'func main():int{let a:char*="abc";let b:int=13;put("hoge");put(a);put(b);}'
assert_input 'cat expected/imms-vs-vnum' 'func main():int{let a:char*="abc";let b:int=13;put("hoge");put(a);put(b);}'
assert_input 'cat expected/vs-imms-vnum' 'func main():int{let a:char*="abc";put(a);put("hoge");let b:int=13;put(b);}'
assert_input 'cat expected/vs-imms-vnum' 'func main():int{let a:char*="abc";put(a);let b:int=13;put("hoge");put(b);}'
assert_input 'cat expected/vs-imms-vnum' 'func main():int{let a:char*="abc";let b:int=13;put(a);put("hoge");put(b);}'
assert_input 'cat expected/vnum-vs-imms' 'func main():int{let b:int=13;put(b);let a:char*="abc";put(a);put("hoge");}'
assert_input 'cat expected/vnum-vs-imms' 'func main():int{let b:int=13;let a:char*="abc";put(b);put(a);put("hoge");}'
assert_input 'cat expected/vs-vnum-imms' 'func main():int{let a:char*="abc";let b:int=13;put(a);put(b);put("hoge");}'
assert_input 'cat expected/vs-vnum-imms' 'func main():int{let a:char*="abc";put(a);let b:int=13;put(b);put("hoge");}'
assert_input 'cat expected/vnum-imms-vs' 'func main():int{let b:int=13;put(b);put("hoge");let a:char*="abc";put(a);}'
assert_input 'cat expected/vnum-imms-vs' 'func main():int{let b:int=13;let a:char*="abc";put(b);put("hoge");put(a);}'
assert_input 'cat expected/for' 'func main():int{let i:int;for i=1;i<4;i=i+1{put(i);}}'
assert_input 'cat expected/twice-imms' 'func main():int{put("hoge");put("hoge");}'
assert_input 'cat expected/twice-vnum' 'func main():int{let a:int=13;put(a);put(a);}'
assert_input 'cat expected/twice-vs' 'func main():int{let b:char*="abc";put(b);put(b);}'
echo -e "\e[1;34m< arithmetic >\e[0m"
...
assert 6 'func main():int{return -3 * (-2);}'
